...
Obsoletes:      libtscam-devel < 1.55.24621
...
case %{_arch} in
  x86_64)
    cp x64/libtscam.so %{buildroot}%{_libdir}/libtscam.so.%{version}
...
%changelog
* Sun Feb 18 2024 James Fidell <james@openastroproject.org> - 1.55.24621-0
